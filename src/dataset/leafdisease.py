    ...
    if transform == "strong":
        train_trans = A.Compose([
                A.Compose([
                    A.RandomRotate90(),
                    A.Flip(),
                    A.RandomResizedCrop(width=config.image_size, height=config.image_size, scale=(0.4, 1.0)),
        ...
        train_trans =  A.Compose([
                A.Compose([
                    ...
                    A.Flip(p=0.5),
                    A.ShiftScaleRotate(shift_limit=0.0625, scale_limit=0.4, rotate_limit=45, p=0.2),
