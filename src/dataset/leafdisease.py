...
def get_albu_transform(transform, config):
    ...
    if transform == "strong":
        ...
        train_trans =  A.Compose([
                ...
                # 光照色彩
                A.RandomSunFlare(num_flare_circles_lower=1, num_flare_circles_upper=4, src_radius=100, p=0.3),
                ...
                # 扭曲/Mask
                A.OpticalDistortion(p=0.3),
                A.Cutout(num_holes=1, max_h_size=300, max_w_size=400, fill_value=0, p=0.5),
