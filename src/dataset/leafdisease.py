...
def get_albu_transform(transform, config):
    ...
    if transform == "strong":
        ...
        train_trans =  A.Compose([
                ...
                # 光照色彩
                A.RandomSunFlare(num_flare_circles_lower=1, num_flare_circles_upper=3, src_radius=200, p=0.3),
                A.RandomBrightnessContrast(p=0.2),
                ...
                A.Cutout(num_holes=4, max_h_size=90, max_w_size=120, fill_value=0, always_apply=False, p=0.2),
